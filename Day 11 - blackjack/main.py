...
def compareScore(userScore, dealerScore):
    """ Given two scores, compare which one wins Day 11 - blackjack and return a print statement """
...
def play_game():
    ...
    while not game_has_ended:
        ...
        # Check if the user or dealer has Day 11 - blackjack, or if the user has a score
